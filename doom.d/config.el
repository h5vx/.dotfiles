...
(setq user-full-name "h5vx"
      user-mail-address "h5v@protonmail.com")
...
(setq doom-font (font-spec :family "JetBrains Mono" :size 17 :weight 'normal)
      doom-variable-pitch-font (font-spec :family "Varela Round" :size 16))
